...
export const businessProfileStyles = {
  ...
  input: "w-full rounded-xl border border-gray-300 px-4 py-3 bg-white/50 backdrop-blur-sm focus:ring-2 focus:ring-violet-500 focus:border-violet-500 transition-all duration-200",
  textarea: "w-full rounded-xl border border-gray-300 px-4 py-3 bg-white/50 backdrop-blur-sm focus:ring-2 focus:ring-violet-500 focus:border-violet-500 transition-all duration-200",

  // Upload Areas
  uploadArea: "border-4 border-dashed border-gray-300 rounded-2xl p-6 transition-all duration-300 hover:border-violet-400 group",
  uploadIconContainer: "w-16 h-16 mx-auto rounded-full bg-violet-100 flex items-center justify-center text-violet-500",
  uploadSmallIconContainer: "w-12 h-12 mx-auto rounded-full bg-violet-100 flex items-center justify-center text-violet-500",
  ...
  changeButton: "inline-flex items-center gap-2 px-3 py-2 sm:px-4 sm:py-2 md:px-5 md:py-2.5 rounded-xl bg-violet-50 text-violet-700 hover:bg-violet-100 transition-all duration-200 cursor-pointer font-medium text-sm sm:text-base",
  ...
  // Tax Section
  taxContainer: "bg-gradient-to-br from-violet-50 to-fuchsia-50 rounded-2xl p-6 border border-violet-100",
  taxInput: "w-32 rounded-xl border border-gray-300 px-4 py-3 bg-white focus:ring-2 focus:ring-violet-500 focus:border-violet-500 transition-all duration-200 font-medium text-center",
...
export const iconColors = {
  ...
  branding: "bg-fuchsia-100 text-fuchsia-600",
  assets: "bg-emerald-100 text-emerald-600"
};
...
export const createInvoiceStyles = {
  ...
  cardIconContainer:
    "p-2 rounded-lg w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 flex items-center justify-center bg-violet-50 text-violet-600",
  ...
  input:
    "w-full rounded-xl border border-gray-300 px-4 py-3 bg-white/50 backdrop-blur-sm focus:ring-2 focus:ring-violet-500 focus:border-violet-500 transition-all duration-200",

  inputMedium:
    "w-full rounded-xl border border-gray-300 px-4 py-3 bg-white/50 backdrop-blur-sm focus:ring-2 focus:ring-violet-500 focus:border-violet-500 transition-all duration-200 font-medium",

  inputCenter:
    "w-full rounded-xl border border-gray-300 px-4 py-3 bg-white/50 backdrop-blur-sm focus:ring-2 focus:ring-violet-500 focus:border-violet-500 transition-all duration-200 text-center font-medium",

  textarea:
    "w-full rounded-xl border border-gray-300 px-4 py-3 bg-white/50 backdrop-blur-sm focus:ring-2 focus:ring-violet-500 focus:border-violet-500 transition-all duration-200",

  inputSmall:
    "w-full rounded-xl border text-gray-500 border-gray-300 px-4 py-3 bg-white/50 backdrop-blur-sm focus:ring-2 focus:ring-violet-500 focus:border-violet-500 transition-all duration-200 text-sm",
  ...
  saveButton:
    "inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-semibold hover:from-violet-700 hover:to-fuchsia-700 transform hover:scale-105 transition-all duration-200 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed",
  ...
  addItemButton:
    "inline-flex items-center gap-2 px-6 py-3 rounded-xl border-2 border-dashed border-gray-300 text-gray-600 hover:border-violet-400 hover:text-violet-600 transition-all duration-200 font-medium w-full justify-center group",
  ...
  statusDropdown:
    "mt-2 sm:hidden w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-violet-500 focus:border-violet-500 transition-all duration-200",
  ...
  // itemsInput:
  //   "rounded-xl border border-gray-300 px-4 py-3 bg-white/50 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-violet-500 transition-all duration-200 w-full min-w-0 overflow-hidden truncate text-sm sm:text-base",

  itemsInput:
    "rounded-xl border border-gray-300 px-4 py-3 bg-white/50 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-violet-500 transition-all duration-200 w-full min-w-0 text-sm sm:text-base",
  itemsNumberInput:
    "rounded-xl border border-gray-300 px-3 py-3 bg-white/50 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-violet-500 transition-all duration-200 text-right w-full min-w-0 overflow-x-auto whitespace-nowrap text-sm sm:text-base",
  ...
  // Upload
  uploadArea:
    "border-4 border-dashed border-gray-300 rounded-2xl p-6 transition-all duration-300 hover:border-violet-400 group",

  uploadSmallArea:
    "border-4 border-dashed border-gray-300 rounded-2xl p-6 transition-all duration-300 hover:border-violet-400 group",

  uploadIconContainer:
    "w-12 h-12 mx-auto rounded-full bg-violet-100 flex items-center justify-center text-violet-600",

  uploadSmallIconContainer:
    "w-10 h-10 mx-auto rounded-full bg-violet-100 flex items-center justify-center text-violet-600",
  ...
  totalRow:
    "flex items-center justify-between py-3 border-t border-gray-200",
...
export const createInvoiceIconColors = {
  ...
  billTo: "bg-fuchsia-100 text-fuchsia-600",
...
export const appShellStyles = {
  // Layout
  root: "min-h-screen bg-gradient-to-br from-gray-50 via-violet-50/30 to-fuchsia-50/20",
  layout: "flex min-h-screen",

  // Desktop Sidebar
  sidebar:
    "hidden lg:flex flex-col min-h-screen bg-white/80 backdrop-blur-xl border-r border-gray-200/60 transition-all duration-500 ease-in-out relative",
  sidebarCollapsed: "w-20",
  sidebarExpanded: "w-80",
  sidebarGradient:
    "absolute inset-0 bg-gradient-to-b from-violet-50/10 to-transparent pointer-events-none",
  ...
  logoTextContainer: "",
  logoText:
    "font-bold text-3xl bg-gradient-to-r from-violet-600 to-fuchsia-600 bg-clip-text text-transparent",
  logoUnderline:
    "h-0.5 w-0 group-hover:w-full bg-gradient-to-r from-violet-500 to-fuchsia-500 transition-all duration-500 mt-1",
  collapseButton:
  ...
  sidebarLinkActive:
    "bg-gradient-to-r from-violet-50 to-fuchsia-50 text-violet-700 shadow-sm border border-violet-100",
  sidebarLinkInactive:
    "text-gray-600 hover:text-gray-900 hover:bg-white hover:shadow-md",
  sidebarIcon: "transition-all duration-300",
  sidebarIconActive: "text-violet-600 scale-110",
  sidebarIconInactive:
  ...
  logoutButton:
    "w-full flex items-center gap-3 px-3 py-3 rounded-xl text-sm font-medium text-rose-600 hover:bg-rose-50 hover:shadow-sm transition-all duration-300 group",
  ...
  mobileLogoText:
    "font-bold text-xl ml-3 bg-gradient-to-r from-violet-600 to-fuchsia-600 bg-clip-text text-transparent",
  mobileCloseButton:
  ...
  mobileLogoutButton:
    "w-full flex items-center gap-3 px-3 py-3 rounded-xl text-sm font-medium text-rose-600 hover:bg-rose-50 transition-all duration-300",
  ...
  mobileAvatar:
    "w-8 h-8 rounded-xl bg-gradient-to-br from-violet-500 to-fuchsia-600 flex items-center justify-center text-white text-xs font-semibold shadow-lg",
  ...
  ctaButton:
    "group inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-2 sm:py-3 rounded-xl bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 hover:from-violet-700 hover:to-fuchsia-700 text-sm sm:text-base flex-1 sm:flex-none justify-center",
  ...
  userAvatar:
    "w-12 h-12 rounded-2xl bg-gradient-to-br from-violet-500 to-fuchsia-600 flex items-center justify-center text-white font-semibold shadow-lg transform hover:scale-105 transition-all duration-300 cursor-pointer group",
  userAvatarBorder:
...
export const dashboardStyles = {
  ...
  // Quick Stats Card
  quickStatsCard: "bg-gradient-to-br from-violet-600 to-fuchsia-700 rounded-2xl p-6 text-white",
  quickStatsTitle: "font-semibold text-lg mb-4",
  quickStatsRow: "flex justify-between items-center",
  quickStatsLabel: "text-violet-100",
  ...
  tableActionButton: "mt-3 sm:mt-0 inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-violet-600 hover:text-fuchsia-600 transition-colors duration-200",
  ...
  // Client Avatar
  clientAvatar: "w-10 h-10 rounded-lg bg-gradient-to-br from-violet-100 to-fuchsia-100 flex items-center justify-center text-violet-600 font-medium group-hover:scale-110 transition-transform duration-200",
  clientInfo: "font-medium text-gray-900 group-hover:text-violet-600 transition-colors",
  ...
  // Action Button
  actionButton: "inline-flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-600 hover:text-violet-600 hover:bg-violet-50 rounded-lg transition-all duration-200 group/btn",
  ...
  emptyStateAction: "text-violet-600 hover:text-fuchsia-600 font-medium",
...
export const invoicesStyles = {
  ...
  createButton: "inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-semibold hover:from-violet-700 hover:to-fuchsia-700 transform hover:scale-105 transition-all duration-200 shadow-lg",
  ...
  filtersIconContainer: "p-2 rounded-lg bg-violet-100 text-violet-600",
  ...
  searchInput: "w-full rounded-xl border border-gray-300 pl-10 pr-4 py-3 bg-white/50 backdrop-blur-sm focus:ring-2 focus:ring-violet-500 focus:border-blue-500 transition-all duration-200",
  selectInput: "w-full rounded-xl border border-gray-300 px-4 py-3 bg-white/50 backdrop-blur-sm focus:ring-2 focus:ring-violet-500 focus:border-blue-500 transition-all duration-200",

  // Date Range
  dateRangeContainer: "lg:col-span-2",
  dateRangeFlex: "flex flex-col sm:flex-row sm:items-center gap-3",
  dateInput: "w-full sm:flex-1 min-w-0 rounded-xl border border-gray-300 px-4 py-3 bg-white/50 backdrop-blur-sm focus:ring-2 focus:ring-violet-500 focus:border-blue-500 transition-all duration-200",
  ...
  perPageSelect: "rounded-xl border border-gray-300 px-4 py-2 bg-white/50 backdrop-blur-sm focus:ring-2 focus:ring-violet-500 focus:border-blue-500 transition-all duration-200",
  ...
  clientAvatar: "w-12 h-12 rounded-xl bg-gradient-to-br from-blue-100 to-indigo-100 flex items-center justify-center text-violet-600 font-medium group-hover:scale-110 transition-transform duration-200",
  clientInfo: "font-medium text-gray-900 group-hover:text-violet-600 transition-colors",
  ...
  viewButton: "inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-600 hover:text-violet-600 hover:bg-violet-50 rounded-lg transition-all duration-200 group/btn",
  sendButton: "inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-violet-600 hover:text-blue-700 hover:bg-violet-50 rounded-lg transition-all duration-200 group/btn",
  ...
  emptyStateAction: "text-violet-600 hover:text-blue-700 font-medium",
  ...
  paginationNumberActive: "bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white shadow-lg",
...
export const featuresStyles = {
  ...
  // Background Elements
  backgroundBlob1: "absolute top-0 left-0 w-72 h-72 bg-violet-100 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob",
  ...
  badge: "inline-flex items-center px-4 py-2 rounded-full bg-violet-50 border border-blue-100 mb-6",
  ...
  titleGradient: "bg-gradient-to-r from-violet-600 to-pink-600 bg-clip-text text-transparent",
  ...
  featureCardTitle: "text-sm whitespace-nowrap md:text-lg lg:text-sm xl:text-xl font-bold text-gray-900 group-hover:text-violet-600 transition-colors duration-300",
  ...
  bottomCtaButton: "group inline-flex items-center px-8 py-4 bg-gradient-to-r from-violet-600 to-pink-600 hover:from-blue-700 hover:to-emerald-700 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300",
...
export const heroStyles = {
  // Section
  section: "relative min-h-screen pb-16 flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-violet-50/30 to-fuchsia-50/20",

  // Background Elements
  bgElement1: "absolute top-1/4 -left-10 w-72 h-72 rounded-full blur-3xl opacity-60 bg-gradient-to-r from-violet-200/40 to-fuchsia-300/40 animate-float-slow",
  bgElement2: "absolute bottom-1/4 -right-10 w-96 h-96 rounded-full blur-3xl opacity-50 bg-gradient-to-r from-fuchsia-200/30 to-pink-300/30 animate-float-medium",
  bgElement3: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full blur-3xl opacity-20 bg-gradient-to-r from-emerald-200/20 to-cyan-300/20 animate-pulse-slow",
  ...
  headingLine2: "bg-gradient-to-r from-violet-600 via-fuchsia-600 to-pink-600 bg-clip-text text-transparent",
  ...
  demoFloating1:
    "hidden sm:block absolute -top-6 -left-6 w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-2xl bg-gradient-to-br from-violet-100 to-fuchsia-100 blur-xl opacity-60 animate-float-slow pointer-events-none",
  demoFloating2:
    "hidden sm:block absolute -bottom-8 -right-8 w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32 rounded-2xl bg-gradient-to-br from-fuchsia-100 to-pink-100 blur-xl opacity-40 animate-float-medium pointer-events-none",
  ...
  cardLogo:
    "w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-violet-500 to-fuchsia-600 flex items-center justify-center text-white font-bold text-xs sm:text-sm",
  ...
  itemDot:
    "w-2 h-2 sm:w-2 sm:h-2 rounded-full bg-gradient-to-r from-violet-500 to-fuchsia-500 group-hover/item:scale-150 transition-transform duration-300",
  ...
  totalValue:
    "bg-gradient-to-r from-violet-600 to-fuchsia-600 bg-clip-text text-transparent text-lg sm:text-xl font-bold",
  ...
  sendButton:
    "flex-1 px-4 py-3 rounded-xl bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-medium shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 group/btn text-sm sm:text-base",
  sendButtonText:
    "group-hover/btn:translate-x-1 transition-transform duration-200 inline-block",
  ...
  cornerAccent2:
    "hidden sm:block absolute -bottom-2 -left-2 w-5 h-5 sm:w-6 sm:h-6 border-b-2 border-l-2 border-fuchsia-500 rounded-bl-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500",

  // Card Background
  cardBackground:
    "absolute inset-0 -z-10 bg-gradient-to-br from-violet-50/30 to-fuchsia-100/20 rounded-2xl sm:rounded-3xl blur-xl transform scale-100 sm:scale-105",
...
export const invoicePreviewStyles = {
  // Layout
  pageContainer: "min-h-screen p-6 bg-gradient-to-br from-gray-50 via-violet-50/30 to-fuchsia-50/20",
  ...
  printButton: "inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-semibold hover:from-violet-700 hover:to-fuchsia-700 transform hover:scale-105 transition-all duration-200 shadow-lg",
  ...
  emptyStateButton: "inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-semibold hover:from-violet-700 hover:to-fuchsia-700 transition-all duration-200 shadow-lg"
};
// src/assets/dummyStyles.js (add these to the existing export)
export const pricingStyles = {
  ...
  // Background Elements
  bgElement1: "absolute top-0 left-0 w-72 h-72 bg-violet-100 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob",
  ...
  titleGradient: "bg-gradient-to-r from-violet-600 to-fuchsia-600 bg-clip-text text-transparent",
  ...
  billingButtonActive: "bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white shadow-lg",
  ...
  contactLink: "text-violet-600 font-semibold hover:text-blue-700 transition-colors duration-300"
};
...
export const pricingCardStyles = {
  ...
  ctaButtonPopular: "bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white shadow-lg hover:shadow-xl hover:from-violet-700 hover:to-fuchsia-700 transform ",
...
export const navbarStyles = {
  ...
  signUpButton: "group relative inline-flex items-center justify-center gap-2 px-6 py-3 rounded-2xl bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 hover:from-violet-700 hover:to-fuchsia-700 overflow-hidden",
...
export const kpiCardStyles = {
  ...
  iconColors: {
    ...
    growth: "from-cyan-500 to-blue-600",
...
export const loginStyles = {
  ...
  root: "h-screen w-full bg-gradient-to-br from-gray-50 via-violet-50/30 to-fuchsia-50/20",
